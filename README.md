# Проект `Делись!` - Cервис для шеринга вещей

Это приложение похоже на каршеринг, только для вещей. В нём можно будет обмениваться с друзьями вещами на время: инструментами, гаджетами, книгами и так далее.
![img](shareIt.png)
